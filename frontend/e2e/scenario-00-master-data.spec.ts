...
test('カレンダー作成〜公開〜勤務形態作成〜シフト生成〜有給付与ルール作成〜手動付与', async ({ page }) => {
  ...
  // --- UC-C003: シフト生成 ---
  await pickUser(page, '対象社員', SCENARIO_USERS.punchEmployee, 'kenta.takahashi@example.com')
  ...
  // --- UC-P002: 手動付与 ---
  await pickUser(page, '対象社員', SCENARIO_USERS.monthlyEmployee, 'mai.ito@example.com')
