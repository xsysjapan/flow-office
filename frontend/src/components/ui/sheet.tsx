  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          'fixed z-50 flex flex-col gap-4 overflow-y-auto border-border bg-card p-4 text-card-foreground shadow-sm outline-none focus-visible:ring-0 transition ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:duration-200 data-[state=open]:duration-300',
          side === 'left' &&
