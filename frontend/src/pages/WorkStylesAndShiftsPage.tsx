...
export function WorkStylesAndShiftsPage() {
  const { data: workStyles, isLoading: isLoadingWorkStyles, error: workStylesError } = useWorkStyles()
  ...
  return (
    <div className="work-styles-and-shifts">
      <Card title="勤務形態">
        {workStylesError && <ErrorMessage error={workStylesError} fallback="勤務形態の取得に失敗しました。" />}
        ...
        <Button
          ...
          disabled={!code || !name || !workTimeSystem || !prescribedDailyMinutes || !prescribedWeeklyMinutes || !calendarId}
