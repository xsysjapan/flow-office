...
const sample: WorkflowRequest[] = [
  ...
  },
  {
    ...
    request_type: { id: 2, code: 'business_card', name: '名刺申請', description: null, form_schema: [], requires_backoffice_task: true, backoffice_task_type: 'business_card', is_active: true },
...
const meta = {
  title: 'Pages/WorkflowRequestListPage',
