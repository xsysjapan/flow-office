 ...
 */
class GeneratePatternCalendarEntriesTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_preview_pattern_does_not_persist_anything(): void
    {
        ...
        $response = $this->actingAs($admin)->postJson('/api/employee-calendar-entries/preview-pattern', [
            'from' => '2026-08-01',
            'to' => '2026-08-09',
    ...
    public function test_weekly_pattern_expands_only_on_matching_weekdays(): void
    {
        ...
        $response = $this->actingAs($admin)->postJson('/api/employee-calendar-entries/generate-pattern', [
            'user_id' => $employee->id,
        ...
        $saturday = EmployeeCalendarEntry::query()
        ...
        $monday = EmployeeCalendarEntry::query()
    ...
    public function test_monthly_day_override_marks_only_that_day_as_manually_overridden(): void
    {
        ...
        $unaffected = EmployeeCalendarEntry::query()
    ...
    public function test_days_with_actual_attendance_or_manual_overrides_are_skipped_by_default(): void
    {
        ...
        $this->actingAs($admin)->postJson('/api/employee-calendar-entries/generate-pattern', [
            'user_id' => $employee->id,
            'work_style_id' => $workStyle->id,
            'from' => '2026-08-01',
            'to' => '2026-08-09',
        ...
        AttendanceDay::query()->create([
            'user_id' => $employee->id, 'work_date' => '2026-08-03', 'calendar_entry_id' => $monday->id,
        ...
        $response = $this->actingAs($admin)->postJson('/api/employee-calendar-entries/generate-pattern', [
            ...
            'to' => '2026-08-09',
            'weekly_pattern' => $this->weekdayPattern(),
            'overwrite_mode' => GeneratePatternCalendarEntries::OVERWRITE_MODE_SKIP_EDITED,
        ]);
