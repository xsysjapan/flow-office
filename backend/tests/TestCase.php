...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function assignRole(User $user, Role $role): RoleAssignment
    {
        ...
        $rolePermissions = [
            ...
            Role::ADMIN => ['user.view', 'user.create', 'user.update', 'user.disable', 'user.manage', 'group.view', 'group.create', 'group.update', 'group.disable', 'group.membership.update', 'group.change.schedule', 'group_type.view', 'group_type.create', 'group_type.update', 'role.view', 'role.create', 'role.update', 'role.assign', 'feature.view', 'feature.assign', 'external_identity.view', 'external_identity.manage', 'field_authority.view', 'field_authority.update', 'authentication_key.view', 'authentication_key.manage', 'external_hr.import', 'backoffice_task.execute', 'attendance.export', 'attendance.manage', 'attendance.month_reopen', 'attendance.confirmation_revert', 'leave.manage', 'expense.export', 'expense_preset.manage', 'request_type.manage', 'expense_category.manage', 'attendance_reminder_exclusion.manage', 'device.manage', 'external_integration_connection.manage', 'audit_log.view', 'audit_log.export', 'attendance.read', 'attendance.update', 'approval.execute', 'approval.route.change', 'system_settings.read', 'system_settings.update', 'admin_command.view', 'admin_command.execute'],
        ];
