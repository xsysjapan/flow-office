 ...
 * hire_date (入社日) はMS365に対応する属性がないため同期対象外で、管理者が個別に設定する
 * (docs/09-usecases-paid-leave.md UC-P002: 継続勤務期間の計算に使う)。
 */
#[Fillable(['entra_user_id', 'name', 'email', 'department', 'job_title', 'employment_status', 'timezone', 'hire_date', 'last_login_at'])]
