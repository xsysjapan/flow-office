...
class WorkflowRequest extends Model
{
     ...
     * 個別に対応する)。
     */
    public function subjectModel(): AttendanceMonth|CompensatoryLeaveRequest|ExpenseClaim|PaidLeaveRequest|SpecialLeaveRequest|null
    {
        return match ($this->subject_type) {
            ...
            'compensatory_leave_request' => CompensatoryLeaveRequest::query()->with(['user'])->find($this->subject_id),
            default => null,
        };
    }
