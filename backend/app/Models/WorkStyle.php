 ...
 */
#[Fillable(['id', 'code', 'name', 'employment_category_id', 'work_time_system', 'workday_boundary_type', 'workday_boundary_time', 'prescribed_daily_minutes', 'prescribed_weekly_minutes', 'weekly_scheduled_days', 'annual_scheduled_days', 'agreed_scheduled_days_per_year', 'deemed_daily_minutes', 'default_start_time', 'default_end_time', 'default_break_minutes', 'rounding_unit_minutes', 'rounding_mode', 'default_break_start_time', 'default_break_end_time', 'auto_break_enabled', 'company_calendar_id', 'is_shift_based', 'is_default', 'system_generated', 'legal_holiday_rule', 'four_week_period_start_date', 'variable_period_start_day', 'max_consecutive_work_days', 'settlement_start_day', 'core_time_enabled', 'core_time_start', 'core_time_end', 'flexible_time_start', 'flexible_time_end'])]
class WorkStyle extends Model
{
    use HasUuids;

    public const WORKDAY_BOUNDARY_MIDNIGHT = 'midnight';

    public const WORKDAY_BOUNDARY_WORK_DATE = 'work_date';

    public const WORKDAY_BOUNDARY_CUSTOM = 'custom';
