...
class AttendanceDailyCalculationResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'prescribed_statutory_within_work_minutes' => $this->prescribed_statutory_within_work_minutes,
            'non_prescribed_statutory_within_work_minutes' => $this->non_prescribed_statutory_within_work_minutes,
            'prescribed_statutory_excess_work_minutes' => $this->prescribed_statutory_excess_work_minutes,
            'non_prescribed_statutory_excess_work_minutes' => $this->non_prescribed_statutory_excess_work_minutes,
            ...
            'late_night_prescribed_statutory_within_work_minutes' => $this->late_night_prescribed_statutory_within_work_minutes,
            'late_night_non_prescribed_statutory_within_work_minutes' => $this->late_night_non_prescribed_statutory_within_work_minutes,
            'late_night_prescribed_statutory_excess_work_minutes' => $this->late_night_prescribed_statutory_excess_work_minutes,
            'late_night_non_prescribed_statutory_excess_work_minutes' => $this->late_night_non_prescribed_statutory_excess_work_minutes,
