...
class AttendanceDailyCalculationResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'regular_work_late_night_minutes' => $this->regular_work_late_night_minutes,
            'non_statutory_overtime_late_night_minutes' => $this->non_statutory_overtime_late_night_minutes,
