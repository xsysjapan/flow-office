...
class CompensatoryLeaveUsageResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'compensatory_leave_grant_id' => $this->compensatory_leave_grant_id,
            'compensatory_leave_request_id' => $this->compensatory_leave_request_id,
